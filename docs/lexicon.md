...
- **Definition**: The physical pin on the J1772 connector that carries the pilot signal. SideCharge taps the Cp pin to read pilot voltage (via ADC on AIN0) and to spoof state changes (via the charge enable output).
